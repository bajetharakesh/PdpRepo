...
public class TestBarqs extends Common {
    @Parameters({"urlbarqs"})
    @Test
    public void LaunchSite(String urlbarqs) {
        help.launchUrl(urlbarqs);
        help.checkPageLoad();
        List<WebElement> allProduct = driver.findElements(By.xpath(prop.getLocator("Barqs.PLPContainer")));
        if (allProduct != null)
        {
